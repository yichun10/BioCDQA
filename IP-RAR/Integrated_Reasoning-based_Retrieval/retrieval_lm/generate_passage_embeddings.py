...
#                 logging.warning(f"Skipping passage due to missing 'id' or 'text': {p}")
#                 continue
#             batch_ids.append(p["id"])
...
#         logging.warning("No valid embeddings generated. Returning empty lists.")
#         return [], []
...
#     if not allids:
#         logging.warning("No valid passages processed. Exiting.")
#         return
